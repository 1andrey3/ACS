<link href="<?= base_url('assets/css/inputFile.css?v=' . validarEnProduccion()) ?>" rel="stylesheet" />
...
<script src="<?= base_url("assets/js/modules/loadInformation.js?v=" . validarEnProduccion()) ?>" type="text/javascript"></script >